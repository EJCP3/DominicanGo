 ...
 * - Bah├¡a de Saman├í (italic text in the water area)
...
function renderOverlays(px, py) {
    ...
    // ----------------------------------------------------------------
    // Bah├¡a de Saman├í ΓÇö italic text in the water between the peninsula
    // and the main coast (~lng -69.5, lat 19.05)
    // ----------------------------------------------------------------
    addLabel(-69.45, 19.08, 'Bah├¡a de Saman├í', 6.5, 0.75);

    // ----------------------------------------------------------------
    // Lago Enriquillo ΓÇö distinctive water ellipse + label
    // ----------------------------------------------------------------
    {
    ...
    // Islands ΓÇö italic text labels only (no shapes)
