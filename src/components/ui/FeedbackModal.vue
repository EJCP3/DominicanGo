<template>
  ...
  <!-- Botón flotante para abrir el modal (bolita marrón esquina inferior derecha) -->
  <button
    type="button"
    @click="openModal"
    class="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 hover:shadow-2xl"
    style="background: #7C4B2A; border: 3px solid #c49a6c;"
    aria-label="Abrir sugerencias"
    title="Sugerencias y Reportes"
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#f5e0c8" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
